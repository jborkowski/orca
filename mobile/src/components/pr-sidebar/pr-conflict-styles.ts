...
// the shared sidebar style sheets each stay focused. Ports the LOOK of the desktop
// ConflictingFilesSection / MergeConflictNotice.
export function createPrConflictStyles(colors: MobileThemeColors, chrome: MobileEinkChrome) {
