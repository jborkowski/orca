...
export function createMobileSourceControlHubStyles(colors: MobileThemeColors) {
...
export function useMobileSourceControlHubStyles() {
  const { colors } = useMobileTheme()
  return useMemo(() => createMobileSourceControlHubStyles(colors), [colors])
}
