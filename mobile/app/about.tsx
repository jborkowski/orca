...
export default function AboutScreen() {
  ...
  const styles = useMemo(() => createAboutStyles(colors, chrome), [colors, chrome])
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top + spacing.sm }]}>
      ...
      <View style={styles.section}>
        ...
        >
          <GithubIcon color={colors.textSecondary} />
...
function createAboutStyles(colors: MobileThemeColors, chrome: MobileEinkChrome) {
